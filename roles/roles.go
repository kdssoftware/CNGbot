...
func FormatMissingSeatGreeting(discordID, seatURL string) string {
	if seatURL != "" {
		return fmt.Sprintf("<@%s>, you need to log into SeAT to receive your roles. Please visit %s", discordID, seatURL)
	}
